...
static	uint8_t wData[0x100];   //写缓存数组
static	uint8_t rData[0x100];   //读缓存数组
void W25Qx_Test(void)
{
	...
	{
			printf("W25Q32FV QuadSPI Test OK\n");
			OLED_ShowStr(0,6,(unsigned char *)"W25Q32 Test OK  ",2); 
	}
	else
	{
			printf("W25Q32FV QuadSPI Test False\n");
			OLED_ShowStr(0,6,(unsigned char *)"W25Q32 Test Fail",2); 
	}
